...
export function ExpandableRowContent({
    ...
    return (
        <div className="p-4 grid grid-cols-1 lg:grid-cols-12 gap-6 bg-muted/20 border-t">
            {/* A. Information Section (3 cols) */}
            <div className="lg:col-span-3 space-y-6 border-r pr-6 border-dashed border-gray-200 dark:border-gray-700">
            ...
            {/* B. Detailed Breakdown Section (5 cols) */}
            <div className="lg:col-span-5 space-y-6 border-r pr-6 border-dashed border-gray-200 dark:border-gray-700">
                {/* Product Info */}
                ...
                <div className="space-y-3">
                    <h4 className="text-sm font-semibold">비용 상세</h4>
                    <div className="bg-slate-50 dark:bg-slate-900 rounded-lg p-3 space-y-2 text-sm">
                        <div className="flex justify-between">
                        ...
                        <div className="border-t pt-2 mt-1 flex justify-between text-base font-bold text-blue-600">
                            <span>= 정산예상금액</span>
            ...
            <div className="lg:col-span-4 space-y-6 flex flex-col justify-between h-full">
                <div className="space-y-2">
                    <h4 className="text-sm font-semibold">워크플로우</h4>
                    <div className="grid grid-cols-1 gap-2">
                        ...
                        {order.status === '신규 주문' && (
                            <>
                                ...
                                >
                                    <span className="w-5 mr-2">🔍</span> 추가 소싱하기
                                </Button>
                            </>
                        )}

                        {['발송대기', '배송중', '오류입고', '국내 배송중'].includes(order.status) && (
                            <>
                                {order.status.includes('국내') && (
                                    <Button variant="secondary" className="w-full justify-start text-blue-600 bg-blue-50 hover:bg-blue-100 border-blue-200">
                                        <span className="w-5 mr-2">🚛</span> 국내 송장 확인
                                    </Button>
                                )}
                                <Button
                                    variant="outline"
                                ...
                                >
                                    <span className="w-5 mr-2">📦</span> 배송대행지 관리
                                    {order.warehouse && <Badge variant="secondary" className="ml-auto text-[10px]">1</Badge>}
                                </Button>
                                <Button
                                    variant="outline"
                                    className="w-full justify-start"
                                ...
                                >
                                    <span className="w-5 mr-2">🌏</span> 배송 추적
                                </Button>
                            </>
                        )}
                        ...
                        >
                            <span className="w-5 mr-2">📋</span> 주문 히스토리 보기
                        </Button>
                    </div>
                </div>
                ...
                <div className="space-y-2 mt-auto">
                    <div className="flex items-center gap-1.5">
                        <h4 className="text-sm font-semibold">내부 관리 메모</h4>
